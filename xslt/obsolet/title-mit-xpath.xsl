...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template
        match="//tei:bibl[tei:author and tei:title[@level='j'] and not(tei:title[not(@level='j')])]/text()[not(normalize-space(.)='')][1]">
        
            
                <xsl:element name="titleX" namespace="http://www.tei-c.org/ns/1.0">
